...
import { AlertCircle, CheckCircle2, XCircle, ChevronDown, ChevronUp, Inbox } from 'lucide-react';
...
export default function SupportPage() {
  ...
  return (
    <div style={{ padding: '2rem' }}>
      ...
      <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem' }}>Messages from users — suggestions, bug reports and questions. Tap a chat to open it.</p>
