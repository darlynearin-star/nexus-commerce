...
const KEY_PREFIXES = ['MTN_', 'AIRTEL_', 'FLUTTERWAVE_', 'RESEND_', 'GMAIL_', 'GOOGLE_', 'AUTH_'];

const ALL_KEYS = [
  'MTN_MOMO_API_KEY', 'MTN_MOMO_API_USER', 'MTN_MOMO_BASE_URL', 'MTN_MOMO_TARGET_ENVIRONMENT',
