    ...
    <div style={{ padding: '2rem', maxWidth: 960, margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div>
              ...
              <input id="productName" className="input" value={form.name} onChange={e => update('name', e.target.value)} />
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
              <div>
                <label htmlFor="productBrand" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>Brand<FieldInfo text="The brand or manufacturer of this product (e.g., Samsung, Gucci, Toyota)." /></label>
            ...
            <div>
              <label htmlFor="productDescription" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>Description<FieldInfo text="A detailed description of your product. Include materials, sizing, features." /></label>
              <textarea id="productDescription" className="input" rows={4} value={form.description} onChange={e => update('description', e.target.value)} style={{ resize: 'vertical' }} />
            </div>
          </div>
        </div>
        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '0.75rem' }}>
            <div>
              ...
              <input id="productPrice" className="input" type="number" value={form.price} onChange={e => update('price', e.target.value)} />
            </div>
            <div>
              <label htmlFor="productCompareAtPrice" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>Compare-at Price<FieldInfo text="The original price shown with a strikethrough to highlight a discount. Leave empty if not on sale." /></label>
              <input id="productCompareAtPrice" className="input" type="number" value={form.compareAtPrice} onChange={e => update('compareAtPrice', e.target.value)} />
            </div>
            <div>
              <label htmlFor="productCostPerItem" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>Cost per Item<FieldInfo text="How much you paid to make or buy this item. Used to calculate profit. Customers don't see this." /></label>
              <input id="productCostPerItem" className="input" type="number" value={form.costPerItem} onChange={e => update('costPerItem', e.target.value)} />
            </div>
          </div>
        </div>
        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
            <div><label htmlFor="productStock" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>Stock Quantity<FieldInfo text="How many units you have available to sell." /></label><input id="productStock" className="input" type="number" value={form.stock} onChange={e => update('stock', e.target.value)} /></div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {features.map((f, i) => (
              <div key={i} style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                ...
                <input className="input" value={f} onChange={e => setFeature(i, e.target.value)} aria-label={`Feature ${i + 1}`} style={{ flex: 1 }} />
          ...
          <div className="card" style={{ padding: '1.5rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
              {categoryAttrs.map(attr => (
                <div key={attr.key}>
                  <label htmlFor={`attr-${attr.key}`} style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>{attr.label}</label>
        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
            {specs.map((s, i) => (
              <div key={i} style={{ display: 'flex', gap: '0.5rem', alignItems: 'center' }}>
                <input className="input" value={s.key} onChange={e => setSpec(i, 'key', e.target.value)} placeholder="Label" aria-label={`Specification label ${i + 1}`} style={{ width: 200 }} />
                  ...
                  <div>
                    ...
                    {v.options.map((o, oi) => (
                      <div key={oi} style={{ display: 'flex', gap: '0.5rem', alignItems: 'center', marginTop: '0.25rem' }}>
                        <input className="input" value={o.name} onChange={e => setVariantOption(v._key, oi, 'name', e.target.value)} placeholder="Option name" aria-label="Variant option name" style={{ width: 150, fontSize: '0.75rem' }} />
                        <input className="input" value={o.value} onChange={e => setVariantOption(v._key, oi, 'value', e.target.value)} placeholder="Value" aria-label="Variant option value" style={{ width: 150, fontSize: '0.75rem' }} />
        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div><label htmlFor="productSeoTitle" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>SEO Title<FieldInfo text="The title shown in Google search results. If left empty the product name is used." /></label><input id="productSeoTitle" className="input" value={form.seoTitle} onChange={e => update('seoTitle', e.target.value)} /></div>
            <div><label htmlFor="productSeoDescription" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>SEO Description<FieldInfo text="A short description shown below the title in search results." /></label><textarea id="productSeoDescription" className="input" rows={2} value={form.seoDescription} onChange={e => update('seoDescription', e.target.value)} /></div>
        ...
        <div className="card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
              ...
              <div><label htmlFor="productReturnPolicy" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>Return Policy<FieldInfo text="Your return policy for this product (e.g., '30-day returns')." /></label><input id="productReturnPolicy" className="input" value={form.returnPolicy} onChange={e => update('returnPolicy', e.target.value)} /></div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
              <div><label htmlFor="productWarranty" style={{ fontSize: '0.8125rem', fontWeight: 500, display: 'block', marginBottom: '0.25rem' }}>Warranty<FieldInfo text="Warranty information (e.g., '1-year manufacturer warranty')." /></label><input id="productWarranty" className="input" value={form.warranty} onChange={e => update('warranty', e.target.value)} /></div>
