...
function getStoreStatus(store: any): { label: string; color: string; icon: any; message: string } {
  ...
  return { label: 'Disabled', color: 'var(--error)', icon: <EyeOff size={16} />, message: 'Your store has been disabled. Please contact Mr.Dev at lyn.nyx.store@gmail.com for assistance.' };
}
