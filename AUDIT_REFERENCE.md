...
- **Dependencies**: informs H14 (indexes migration). **Verification**: clean-DB migration chain test (local ephemeral Postgres if available; otherwise documented manual procedure + prisma validate + SQL review). **Current state**: NOT STARTED
